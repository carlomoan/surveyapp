...
urlpatterns = [
    ...
    path('equipment/delete/<int:pk>/', views.delete_equipment, name='equipment_delete'),
    path('well/create/', views.add_well, name='development_info_add'),
    path('well/list/', views.WellsListView.as_view(), name='development_info_list'),
    path('well/edit/<int:pk>/', views.edit_well, name='development_info_edit'),
    path('well/<int:pk>/', views.WellDetailView.as_view(), name='development_info_detail'),
    path('well/delete/<int:pk>/', views.delete_well, name='development_info_delete'),
