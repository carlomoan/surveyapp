...
urlpatterns = [
    ...
    path('region/update/<int:pk>', views.RegionUpdateView.as_view(), name='update_region'),
    path('region/delete/<int:pk>', views.RegionDeleteView.as_view(), name='delete_region'),
    ...
    path('district/update/<int:pk>', views.DistrictUpdateView.as_view(), name='update_district'),
    path('district/delete/<int:pk>', views.DistrictDeleteView.as_view(), name='delete_district'),
    ...
    path('street/update/<int:pk>', views.StreetUpdateView.as_view(), name='update_street'),
    path('street/delete/<int:pk>', views.StreetDeleteView.as_view(), name='delete_street'),
