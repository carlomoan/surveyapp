# Generated by Django 2.2.3 on 2021-06-08 13:35
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_roles', models.IntegerField(choices=[(1, 'Admin'), (2, 'Accountant'), (3, 'Store'), (4, 'Surveyor')], default=4)),
                ...
                ('district', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='User_District', to='accounts.District')),
                ('groups', models.ManyToManyField(blank=True, help_text='The groups this user belongs to. A user will get all permissions granted to each of their groups.', related_name='user_set', related_query_name='user', to='auth.Group', verbose_name='groups')),
                ('region', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='User_Region', to='accounts.Region')),
